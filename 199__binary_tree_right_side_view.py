...
class Solution(unittest.TestCase):
    def test_example_1(self):
        ...
        self.assertEqual(self.rightSideView(root), expected)

    def test_example_2(self):
        root = build_tree([1, None, 3])

        self.assertEqual(self.rightSideView(root), [1, 3])

    def test_example_3(self):
        self.assertEqual(self.rightSideView(build_tree([])), [])

    def test_root_plus_left(self):
        self.assertEqual(self.rightSideView(build_tree([1, 2, None])), [1, 2])
