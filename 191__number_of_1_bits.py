...
class Solution(TestCase):
    def test_example_1(self):
        self.assertEqual(3, self.hammingWeight(0b1011))

    def test_example_2(self):
        self.assertEqual(1, self.hammingWeight(0b10000000))

    def test_example_3(self):
        self.assertEqual(31, self.hammingWeight(0b11111111111111111111111111111101))
